...
import {
  ...
  ChartTooltipContent,
  type ChartConfig,
} from '@repo/shared/components/chart';
...
import {
  ...
  DrawerTitle,
  DrawerTrigger,
} from '@repo/shared/components/drawer';
import {
  DropdownMenu,
...
import {
  ...
  SelectTrigger,
  SelectValue,
} from '@repo/shared/components/select';
...
import {
  ...
  TableHeader,
  TableRow,
} from '@repo/shared/components/table';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@repo/shared/components/tabs';
...
export function DataTable({ data: initialData }: { data: Array<z.infer<typeof schema>> }) {
  ...
  const dataIds = useMemo<Array<UniqueIdentifier>>(() => data?.map(({ id }) => id) || [], [data]);
